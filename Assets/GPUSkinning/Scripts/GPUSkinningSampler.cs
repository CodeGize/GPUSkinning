...
public class GPUSkinningSampler : MonoBehaviour
{
    ...
    private const string UnlitShaderTemp = "Assets/GPUSkinning/EditorRes/ShaderTemplate/GPUSkinningUnlit_Template.txt";
    private const string SpecularShaderTemp = "Assets/GPUSkinning/EditorRes/ShaderTemplate/GPUSkinningSpecular_Template.txt";
    private const string MetallicShaderTemp = "Assets/GPUSkinning/EditorRes/ShaderTemplate/GPUSkinningMetallic_Template.txt";
    private const string UnlitShader = "GPUSkinning/GPUSkinning_Unlit_Skin";
    private const string SpecularShader = "GPUSkinning/GPUSkinning_Specular_Skin";
    private const string MetallicShader = "GPUSkinning/GPUSkinning_Metallic_Skin";
    ...
    private void CreateShaderAndMaterial(string dir)
    {
        ...
        if (createNewShader)
        {
            string shaderTemplate =
                shaderType == GPUSkinningShaderType.Unlit ? UnlitShaderTemp :
                shaderType == GPUSkinningShaderType.StandardSpecular ? SpecularShaderTemp :
                shaderType == GPUSkinningShaderType.StandardMetallic ? MetallicShaderTemp : string.Empty;

            string shaderStr = AssetDatabase.LoadAssetAtPath<TextAsset>(shaderTemplate).text;
        ...
        {
            string shaderName =
                shaderType == GPUSkinningShaderType.Unlit ? UnlitShader :
                shaderType == GPUSkinningShaderType.StandardSpecular ? SpecularShader :
                shaderType == GPUSkinningShaderType.StandardMetallic ? MetallicShader : string.Empty;
            shaderName +=
